...
-- [回答]
 SELECT * FROM stock_table 
  JOIN goods_table 
  ON stock_table.goods_code = goods_table.goods_name;

 SELECT * FROM stock_table 
  JOIN store_table 
  ON stock_table.store_code = store_table.store_name;
...
-- [回答]
 ...
 GROUP BY store_code HAVING AVG(quantity) >= 17.3333333333333333
